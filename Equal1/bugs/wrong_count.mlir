...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    ...
    quake.x %2 : (!quake.ref) -> ()
    %3 = cc.alloca !cc.array<i8 x 4>
    %4 = cc.loop while ((%arg0 = %c0_i64) -> (i64)) {
      %8 = arith.cmpi slt, %arg0, %c4_i64 : i64
      cc.condition %8(%arg0 : i64)
    } do {
    ^bb0(%arg0: i64):
      %8 = quake.extract_ref %0[%arg0] : (!quake.veq<4>, i64) -> !quake.ref
      %measOut = quake.mz %8 name "reg" : (!quake.ref) -> !quake.measure
      %9 = quake.discriminate %measOut : (!quake.measure) -> i1
      %10 = cc.compute_ptr %3[%arg0] : (!cc.ptr<!cc.array<i8 x 4>>, i64) -> !cc.ptr<i8>
    ...
    %5 = cc.cast %3 : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<!cc.array<i1 x ?>>
    %6 = cc.stdvec_init %5, %c4_i64 : (!cc.ptr<!cc.array<i1 x ?>>, i64) -> !cc.stdvec<i1>
    %7 = cc.alloca !cc.stdvec<i1>
    cc.store %6, %7 : !cc.ptr<!cc.stdvec<i1>>
    return
  }
}
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    ...
    quake.x %2 : (!quake.ref) -> ()
    %3 = cc.alloca !cc.array<i8 x 4>
    %4 = quake.extract_ref %0[0] : (!quake.veq<4>) -> !quake.ref
    %measOut = quake.mz %4 name "reg" : (!quake.ref) -> !quake.measure
    %5 = quake.discriminate %measOut : (!quake.measure) -> i1
    %6 = cc.cast %3 : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %7 = cc.cast unsigned %5 : (i1) -> i8
    cc.store %7, %6 : !cc.ptr<i8>
    %8 = quake.extract_ref %0[1] : (!quake.veq<4>) -> !quake.ref
    %measOut_0 = quake.mz %8 name "reg" : (!quake.ref) -> !quake.measure
    %9 = quake.discriminate %measOut_0 : (!quake.measure) -> i1
    %10 = cc.compute_ptr %3[1] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %11 = cc.cast unsigned %9 : (i1) -> i8
    cc.store %11, %10 : !cc.ptr<i8>
    %12 = quake.extract_ref %0[2] : (!quake.veq<4>) -> !quake.ref
    %measOut_1 = quake.mz %12 name "reg" : (!quake.ref) -> !quake.measure
    %13 = quake.discriminate %measOut_1 : (!quake.measure) -> i1
    %14 = cc.compute_ptr %3[2] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %15 = cc.cast unsigned %13 : (i1) -> i8
    cc.store %15, %14 : !cc.ptr<i8>
    %16 = quake.extract_ref %0[3] : (!quake.veq<4>) -> !quake.ref
    %measOut_2 = quake.mz %16 name "reg" : (!quake.ref) -> !quake.measure
    %17 = quake.discriminate %measOut_2 : (!quake.measure) -> i1
    %18 = cc.compute_ptr %3[3] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %19 = cc.cast unsigned %17 : (i1) -> i8
    cc.store %19, %18 : !cc.ptr<i8>
    %20 = cc.cast %3 : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<!cc.array<i1 x ?>>
    %21 = cc.stdvec_init %20, %c4_i64 : (!cc.ptr<!cc.array<i1 x ?>>, i64) -> !cc.stdvec<i1>
    %22 = cc.alloca !cc.stdvec<i1>
    cc.store %21, %22 : !cc.ptr<!cc.stdvec<i1>>
    return
  }
}
...
// -----// IR Dump Before ConstPropComplex (const-prop-complex) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump Before Canonicalizer (canonicalize) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump Before CSE (cse) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump After CSE (cse) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
    ...
    %5 = cc.cast %3 : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %6 = cc.cast unsigned %4 : (i1) -> i8
    cc.store %6, %5 : !cc.ptr<i8>
    %7 = quake.extract_ref %0[1] : (!quake.veq<4>) -> !quake.ref
    %measOut_0 = quake.mz %7 name "reg" : (!quake.ref) -> !quake.measure
    %8 = quake.discriminate %measOut_0 : (!quake.measure) -> i1
    %9 = cc.compute_ptr %3[1] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    ...
    %12 = cc.compute_ptr %3[2] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    ...
    %16 = cc.compute_ptr %3[3] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %17 = cc.cast unsigned %15 : (i1) -> i8
    cc.store %17, %16 : !cc.ptr<i8>
    %18 = cc.cast %3 : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<!cc.array<i1 x ?>>
...
// -----// IR Dump Before LiftArrayAlloc (lift-array-alloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump Before CheckKernelCalls (check-kernel-calls) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump Before MemToReg (memtoreg) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump After MemToReg (memtoreg) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c4_i64 = arith.constant 4 : i64
    %0 = quake.alloca !quake.veq<4>
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    ...
    cc.store %6, %5 : !cc.ptr<i8>
    %7 = quake.extract_ref %0[1] : (!quake.veq<4>) -> !quake.ref
    %measOut_0 = quake.mz %7 name "reg%1" : (!quake.ref) -> !quake.measure
    %8 = quake.discriminate %measOut_0 : (!quake.measure) -> i1
    %9 = cc.compute_ptr %3[1] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %10 = cc.cast unsigned %8 : (i1) -> i8
    cc.store %10, %9 : !cc.ptr<i8>
...
// -----// IR Dump Before LowerToCFG (lower-to-cfg) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
    %1 = quake.extract_ref %0[0] : (!quake.veq<4>) -> !quake.ref
...
// -----// IR Dump Before MultiControlDecompositionPass (multicontrol-decomposition) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
    %1 = quake.extract_ref %0[0] : (!quake.veq<4>) -> !quake.ref
...
// -----// IR Dump Before CombineQuantumAllocations (combine-quantum-alloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
    %1 = quake.extract_ref %0[0] : (!quake.veq<4>) -> !quake.ref
...
// -----// IR Dump After CombineQuantumAllocations (combine-quantum-alloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
...
// -----// IR Dump Before ApplyControlNegations (apply-control-negations) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c3_i64 = arith.constant 3 : i64
    %c1_i64 = arith.constant 1 : i64
...
// -----// IR Dump Before QuakeAddDeallocs (add-dealloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c3_i64 = arith.constant 3 : i64
    %c1_i64 = arith.constant 1 : i64
...
// -----// IR Dump After QuakeAddDeallocs (add-dealloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %c3_i64 = arith.constant 3 : i64
    %c1_i64 = arith.constant 1 : i64
...
// -----// IR Dump Before FactorQuantumAllocations (factor-quantum-alloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
    %1 = quake.extract_ref %0[0] : (!quake.veq<4>) -> !quake.ref
...
// -----// IR Dump After FactorQuantumAllocations (factor-quantum-alloc) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    ...
    %2 = quake.null_wire
    %3 = quake.null_wire
    %4 = quake.x %0 : (!quake.wire) -> !quake.wire
    %5 = quake.x %2 : (!quake.wire) -> !quake.wire
    %6 = cc.alloca !cc.array<i8 x 4>
    %measOut, %wires = quake.mz %4 name "reg%0" : (!quake.wire) -> (!quake.measure, !quake.wire)
    %7 = quake.discriminate %measOut : (!quake.measure) -> i1
    %8 = cc.cast %6 : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %9 = cc.cast unsigned %7 : (i1) -> i8
    cc.store %9, %8 : !cc.ptr<i8>
    %measOut_0, %wires_1 = quake.mz %1 name "reg%1" : (!quake.wire) -> (!quake.measure, !quake.wire)
    %10 = quake.discriminate %measOut_0 : (!quake.measure) -> i1
    %11 = cc.compute_ptr %6[1] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %12 = cc.cast unsigned %10 : (i1) -> i8
    cc.store %12, %11 : !cc.ptr<i8>
    %measOut_2, %wires_3 = quake.mz %5 name "reg%2" : (!quake.wire) -> (!quake.measure, !quake.wire)
    %13 = quake.discriminate %measOut_2 : (!quake.measure) -> i1
    %14 = cc.compute_ptr %6[2] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
    %15 = cc.cast unsigned %13 : (i1) -> i8
    cc.store %15, %14 : !cc.ptr<i8>
    %measOut_4, %wires_5 = quake.mz %3 name "reg%3" : (!quake.wire) -> (!quake.measure, !quake.wire)
    %16 = quake.discriminate %measOut_4 : (!quake.measure) -> i1
    %17 = cc.compute_ptr %6[3] : (!cc.ptr<!cc.array<i8 x 4>>) -> !cc.ptr<i8>
...
// -----// IR Dump Before AssignWireIndices (assign-wire-indices) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.null_wire
...
// -----// IR Dump After AssignWireIndices (assign-wire-indices) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
...
// -----// IR Dump Before RegToMem (regtomem) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.borrow_wire @wires[0] : !quake.wire
...
// -----// IR Dump After RegToMem (regtomem) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.ref
...
// -----// IR Dump Before DelayMeasurements (delay-measurements) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump After DelayMeasurements (delay-measurements) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump Before MeasurementMapping (measurement-mapping) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump After MeasurementMapping (measurement-mapping) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  quake.wire_set @wires[2147483647] attributes {sym_visibility = "private"}
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %0 = quake.alloca !quake.veq<4>
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  ...
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    ...
    quake.ry (%cst_2) %1 : (f64, !quake.ref) -> ()
    quake.z %1 : (!quake.ref) -> ()
    ...
    quake.z %2 : (!quake.ref) -> ()
    %measOut_5 = quake.mz %1 name "reg%1" : (!quake.ref) -> !quake.measure
    %12 = quake.discriminate %measOut_5 : (!quake.measure) -> i1
    %13 = cc.cast unsigned %12 : (i1) -> i8
    cc.store %13, %7 : !cc.ptr<i8>
    ...
    quake.ry (%cst_8) %4 : (f64, !quake.ref) -> ()
    quake.z %4 : (!quake.ref) -> ()
    quake.z [%3] %4 : (!quake.ref, !quake.ref) -> ()
    %cst_9 = arith.constant -1.5707963267948966 : f64
    quake.ry (%cst_9) %4 : (f64, !quake.ref) -> ()
    quake.z %4 : (!quake.ref) -> ()
    %cst_10 = arith.constant -1.5707963267948966 : f64
    quake.ry (%cst_10) %3 : (f64, !quake.ref) -> ()
    quake.z %3 : (!quake.ref) -> ()
    quake.z [%4] %3 : (!quake.ref, !quake.ref) -> ()
    %cst_11 = arith.constant -1.5707963267948966 : f64
    quake.ry (%cst_11) %3 : (f64, !quake.ref) -> ()
    quake.z %3 : (!quake.ref) -> ()
    %measOut_12 = quake.mz %4 name "reg%2" : (!quake.ref) -> !quake.measure
    quake.reset %4 : (!quake.ref) -> ()
    ...
    quake.ry (%cst_17) %4 : (f64, !quake.ref) -> ()
    quake.z %4 : (!quake.ref) -> ()
    quake.z [%3] %4 : (!quake.ref, !quake.ref) -> ()
    %cst_18 = arith.constant -1.5707963267948966 : f64
    quake.ry (%cst_18) %4 : (f64, !quake.ref) -> ()
    quake.z %4 : (!quake.ref) -> ()
    %14 = quake.discriminate %measOut_12 : (!quake.measure) -> i1
    %15 = cc.cast unsigned %14 : (i1) -> i8
    cc.store %15, %8 : !cc.ptr<i8>
    %measOut_19 = quake.mz %4 name "reg%3" : (!quake.ref) -> !quake.measure
    %16 = quake.discriminate %measOut_19 : (!quake.measure) -> i1
    %17 = cc.cast unsigned %16 : (i1) -> i8
    cc.store %17, %9 : !cc.ptr<i8>
    quake.dealloc %0 : !quake.veq<4>
    return
...
// -----// IR Dump Before UnwindLowering (unwind-lowering) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %cst = arith.constant -1.5707963267948966 : f64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump Before QuakeAddMetadata (quake-add-metadata) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint"} {
    %cst = arith.constant -1.5707963267948966 : f64
    %0 = quake.alloca !quake.veq<4>
...
// -----// IR Dump After QuakeAddMetadata (quake-add-metadata) ('func.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint", qubitMeasurementFeedback = true} {
    %cst = arith.constant -1.5707963267948966 : f64
    %0 = quake.alloca !quake.veq<4>
    %1 = quake.extract_ref %0[0] : (!quake.veq<4>) -> !quake.ref
    %2 = quake.extract_ref %0[1] : (!quake.veq<4>) -> !quake.ref
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  func.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint", qubitMeasurementFeedback = true} {
    ...
    quake.ry (%cst) %4 : (f64, !quake.ref) -> ()
    quake.z %4 : (!quake.ref) -> ()
    %measOut_1 = quake.mz %5 name "reg%2" : (!quake.ref) -> !quake.measure
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  ...
  llvm.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint", qubitMeasurementFeedback = true} {
    ...
    llvm.call @__quantum__qis__x(%6) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__x(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    %25 = llvm.mlir.addressof @cstr.726567253000 : !llvm.ptr<array<6 x i8>>
    %26 = llvm.bitcast %25 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %27 = llvm.call @__quantum__qis__mz__to__register(%6, %26) {registerName = "reg%0"} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %28 = llvm.bitcast %27 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %29 = llvm.load %28 : !llvm.ptr<i1>
    llvm.call @__quantum__qis__reset(%6) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %30 = llvm.zext %29 : i1 to i8
    llvm.store %30, %21 : !llvm.ptr<i8>
    ...
    llvm.call @invokeWithControlQubits(%32, %31, %6, %10) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %10) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%10) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__ry(%0, %10) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%10) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %35 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %36 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%36, %35, %6, %10) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %10) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%10) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %37 = llvm.mlir.addressof @cstr.726567253100 : !llvm.ptr<array<6 x i8>>
    %38 = llvm.bitcast %37 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %39 = llvm.call @__quantum__qis__mz__to__register(%6, %38) {registerName = "reg%1"} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %40 = llvm.bitcast %39 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %41 = llvm.load %40 : !llvm.ptr<i1>
    %42 = llvm.zext %41 : i1 to i8
    llvm.store %42, %22 : !llvm.ptr<i8>
    ...
    %45 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %46 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%46, %45, %14, %18) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %49 = llvm.mlir.addressof @cstr.726567253200 : !llvm.ptr<array<6 x i8>>
    %50 = llvm.bitcast %49 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %51 = llvm.call @__quantum__qis__mz__to__register(%18, %50) {registerName = "reg%2"} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %52 = llvm.bitcast %51 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    ...
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %56 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %57 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%57, %56, %18, %14) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %58 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %59 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%59, %58, %14, %18) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %60 = llvm.zext %53 : i1 to i8
    llvm.store %60, %23 : !llvm.ptr<i8>
    %61 = llvm.mlir.addressof @cstr.726567253300 : !llvm.ptr<array<6 x i8>>
    %62 = llvm.bitcast %61 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %63 = llvm.call @__quantum__qis__mz__to__register(%18, %62) {registerName = "reg%3"} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %64 = llvm.bitcast %63 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %65 = llvm.load %64 : !llvm.ptr<i1>
    %66 = llvm.zext %65 : i1 to i8
    llvm.store %66, %24 : !llvm.ptr<i8>
...
// -----// IR Dump Before QIRToQIRProfileFunc (quake-to-qir-func) ('llvm.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  llvm.func @__quantum__qis__x__body(!llvm.ptr<struct<"Qubit", opaque>>)
  llvm.func @__quantum__qis__mz__to__register__body(!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
  llvm.func @__quantum__qis__reset__body(!llvm.ptr<struct<"Qubit", opaque>>)
...
// -----// IR Dump After QIRToQIRProfileFunc (quake-to-qir-func) ('llvm.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  llvm.func @__quantum__qis__x__body(!llvm.ptr<struct<"Qubit", opaque>>)
  llvm.func @__quantum__qis__mz__to__register__body(!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
  llvm.func @__quantum__qis__reset__body(!llvm.ptr<struct<"Qubit", opaque>>)
  ...
  llvm.func @__quantum__rt__array_get_element_ptr_1d(!llvm.ptr<struct<"Array", opaque>>, i64) -> !llvm.ptr<i8>
  llvm.func @__quantum__rt__qubit_allocate_array(i64) -> !llvm.ptr<struct<"Array", opaque>>
  llvm.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint", passthrough = ["entry_point", ["qir_profiles", "adaptive_profile"], ["output_labeling_schema", "schema_id"], ["output_names", "[[[0,[0,\22reg%0\22]],[1,[0,\22reg%1\22]],[2,[3,\22reg%2\22]],[3,[3,\22reg%3\22]]]]"], ["requiredQubits", "4"], ["requiredResults", "4"]], qubitMeasurementFeedback = true} {
    %0 = llvm.mlir.constant(-1.5707963267948966 : f64) : f64
    %1 = llvm.mlir.constant(4 : i64) : i64
    ...
    %25 = llvm.mlir.addressof @cstr.726567253000 : !llvm.ptr<array<6 x i8>>
    %26 = llvm.bitcast %25 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %27 = llvm.call @__quantum__qis__mz__to__register(%6, %26) {registerName = "reg%0", result.index = 0 : i64} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %28 = llvm.mlir.constant(0 : i64) : i64
    %29 = llvm.inttoptr %28 : i64 to !llvm.ptr<struct<"Result", opaque>>
    %30 = llvm.mlir.addressof @cstr.726567253000 : !llvm.ptr<array<6 x i8>>
    %31 = llvm.bitcast %30 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    llvm.call @__quantum__rt__result_record_output(%29, %31) : (!llvm.ptr<struct<"Result", opaque>>, !llvm.ptr<i8>) -> ()
    %32 = llvm.bitcast %27 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %33 = llvm.load %32 : !llvm.ptr<i1>
    llvm.call @__quantum__qis__reset(%6) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %34 = llvm.zext %33 : i1 to i8
    llvm.store %34, %21 : !llvm.ptr<i8>
    llvm.call @__quantum__qis__ry(%0, %10) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%10) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %35 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %36 = llvm.mlir.constant(1 : i64) : i64
    ...
    llvm.call @__quantum__qis__ry(%0, %6) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%6) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %37 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %38 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%38, %37, %10, %6) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %6) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%6) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %10) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%10) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @invokeWithControlQubits(%40, %39, %6, %10) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %10) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%10) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %41 = llvm.mlir.addressof @cstr.726567253100 : !llvm.ptr<array<6 x i8>>
    %42 = llvm.bitcast %41 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %43 = llvm.call @__quantum__qis__mz__to__register(%6, %42) {registerName = "reg%1", result.index = 1 : i64} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %44 = llvm.mlir.constant(1 : i64) : i64
    %45 = llvm.inttoptr %44 : i64 to !llvm.ptr<struct<"Result", opaque>>
    %46 = llvm.mlir.addressof @cstr.726567253100 : !llvm.ptr<array<6 x i8>>
    %47 = llvm.bitcast %46 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    llvm.call @__quantum__rt__result_record_output(%45, %47) : (!llvm.ptr<struct<"Result", opaque>>, !llvm.ptr<i8>) -> ()
    %48 = llvm.bitcast %43 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %49 = llvm.load %48 : !llvm.ptr<i1>
    %50 = llvm.zext %49 : i1 to i8
    llvm.store %50, %22 : !llvm.ptr<i8>
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %53 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %54 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%54, %53, %14, %18) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %55 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %56 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%56, %55, %18, %14) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %57 = llvm.mlir.addressof @cstr.726567253200 : !llvm.ptr<array<6 x i8>>
    %58 = llvm.bitcast %57 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %59 = llvm.call @__quantum__qis__mz__to__register(%18, %58) {registerName = "reg%2", result.index = 2 : i64} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %60 = llvm.mlir.constant(2 : i64) : i64
    %61 = llvm.inttoptr %60 : i64 to !llvm.ptr<struct<"Result", opaque>>
    %62 = llvm.mlir.addressof @cstr.726567253200 : !llvm.ptr<array<6 x i8>>
    %63 = llvm.bitcast %62 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    llvm.call @__quantum__rt__result_record_output(%61, %63) : (!llvm.ptr<struct<"Result", opaque>>, !llvm.ptr<i8>) -> ()
    %64 = llvm.bitcast %59 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %65 = llvm.load %64 : !llvm.ptr<i1>
    llvm.call @__quantum__qis__reset(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %68 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %69 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%69, %68, %18, %14) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %14) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%14) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %70 = llvm.mlir.addressof @__quantum__qis__z__ctl : !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>
    %71 = llvm.mlir.constant(1 : i64) : i64
    llvm.call @invokeWithControlQubits(%71, %70, %14, %18) : (i64, !llvm.ptr<func<void (ptr<struct<"Array", opaque>>, ptr<struct<"Qubit", opaque>>)>>, !llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry(%0, %18) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z(%18) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %72 = llvm.zext %65 : i1 to i8
    llvm.store %72, %23 : !llvm.ptr<i8>
    %73 = llvm.mlir.addressof @cstr.726567253300 : !llvm.ptr<array<6 x i8>>
    %74 = llvm.bitcast %73 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    %75 = llvm.call @__quantum__qis__mz__to__register(%18, %74) {registerName = "reg%3", result.index = 3 : i64} : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
    %76 = llvm.mlir.constant(3 : i64) : i64
    %77 = llvm.inttoptr %76 : i64 to !llvm.ptr<struct<"Result", opaque>>
    %78 = llvm.mlir.addressof @cstr.726567253300 : !llvm.ptr<array<6 x i8>>
    %79 = llvm.bitcast %78 : !llvm.ptr<array<6 x i8>> to !llvm.ptr<i8>
    llvm.call @__quantum__rt__result_record_output(%77, %79) : (!llvm.ptr<struct<"Result", opaque>>, !llvm.ptr<i8>) -> ()
    %80 = llvm.bitcast %75 : !llvm.ptr<struct<"Result", opaque>> to !llvm.ptr<i1>
    %81 = llvm.load %80 : !llvm.ptr<i1>
    %82 = llvm.zext %81 : i1 to i8
    llvm.store %82, %24 : !llvm.ptr<i8>
    llvm.call @__quantum__rt__qubit_release_array(%2) : (!llvm.ptr<struct<"Array", opaque>>) -> ()
    llvm.return
  }
  llvm.mlir.global private constant @cstr.726567253000("reg%0\00") {addr_space = 0 : i32}
...
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  ...
  llvm.func @__nvqpp__mlirgen__wrong_count() attributes {"cudaq-entrypoint", passthrough = ["entry_point", ["qir_profiles", "adaptive_profile"], ["output_labeling_schema", "schema_id"], ["output_names", "[[[0,[0,\22reg%0\22]],[1,[0,\22reg%1\22]],[2,[3,\22reg%2\22]],[3,[3,\22reg%3\22]]]]"], ["requiredQubits", "4"], ["requiredResults", "4"]], qubitMeasurementFeedback = true} {
    ...
    llvm.call @__quantum__qis__x__body(%7) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__x__body(%11) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__mz__body(%7, %19) : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Result", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__reset__body(%7) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__cz__body(%13, %11) : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry__body(%5, %11) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z__body(%11) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry__body(%5, %13) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z__body(%13) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__cz__body(%11, %13) : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry__body(%5, %13) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z__body(%13) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry__body(%5, %11) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z__body(%11) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    llvm.call @__quantum__qis__ry__body(%5, %11) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z__body(%11) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    %31 = llvm.inttoptr %3 : i64 to !llvm.ptr<struct<"Result", opaque>>
    llvm.call @__quantum__qis__mz__body(%13, %31) : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Result", opaque>>) -> ()
    %32 = llvm.inttoptr %3 : i64 to !llvm.ptr<struct<"Result", opaque>>
    ...
    llvm.call @__quantum__qis__reset__body(%13) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry__body(%5, %13) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__z__body(%13) : (!llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__cz__body(%11, %13) : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    llvm.call @__quantum__qis__ry__body(%5, %13) : (f64, !llvm.ptr<struct<"Qubit", opaque>>) -> ()
    ...
    %37 = llvm.inttoptr %2 : i64 to !llvm.ptr<struct<"Result", opaque>>
    llvm.call @__quantum__qis__mz__body(%13, %37) : (!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<struct<"Result", opaque>>) -> ()
    %38 = llvm.inttoptr %2 : i64 to !llvm.ptr<struct<"Result", opaque>>
...
// -----// IR Dump Before VerifyQIRProfile (verify-qir-profile) ('llvm.func' operation: @__nvqpp__mlirgen__wrong_count) //----- //
module attributes {quake.mangled_name_map = {__nvqpp__mlirgen__wrong_count = "__nvqpp__mlirgen__wrong_count_PyKernelEntryPointRewrite"}} {
  llvm.func @__quantum__qis__x__body(!llvm.ptr<struct<"Qubit", opaque>>)
  llvm.func @__quantum__qis__mz__to__register__body(!llvm.ptr<struct<"Qubit", opaque>>, !llvm.ptr<i8>) -> !llvm.ptr<struct<"Result", opaque>>
  llvm.func @__quantum__qis__reset__body(!llvm.ptr<struct<"Qubit", opaque>>)
